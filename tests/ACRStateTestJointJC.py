...
from pypastml import acr, JC, JOINT
    ...
    def test_num_Greek_nodes(self):
        ...
        for node in self.tree.traverse():
            if 'Greece' == getattr(node, self.feature):
                num += 1
        self.assertEqual(68, num, msg='Was supposed to have {} Greek nodes, got {}.'.format(68, num))
