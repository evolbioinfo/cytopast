...
from pypastml import acr, F81, JOINT
    ...
    def test_num_Greek_nodes(self):
        ...
        for node in self.tree.traverse():
            if 'Greece' == getattr(node, self.feature):
                num += 1
        self.assertEqual(69, num, msg='Was supposed to have {} Greek nodes, got {}.'.format(69, num))
