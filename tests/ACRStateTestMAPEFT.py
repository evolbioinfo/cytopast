...
from pypastml import acr, EFT, MAP
    ...
    def test_num_African_nodes(self):
        ...
        for node in self.tree.traverse():
            if 'Africa' == getattr(node, self.feature):
                num += 1
        self.assertEqual(111, num, msg='Was supposed to have {} African nodes, got {}.'.format(111, num))
    ...
    def test_num_WE_nodes(self):
        ...
        for node in self.tree.traverse():
            if 'WestEurope' == getattr(node, self.feature):
                num += 1
        self.assertEqual(33, num, msg='Was supposed to have {} West European nodes, got {}.'.format(33, num))
