...
setup(
    ...
    package_data={'cytopast': [os.path.join('templates', '*.html'), os.path.join('templates', '*.js'),
                               os.path.join('examples', '*', 'data',  '*.tre'),
                               os.path.join('examples', '*', 'data',  '*.txt'), os.path.join('*', '*.tree_scripts'),
                               os.path.join('*', '*', '*.tree_scripts'),
    ...
    install_requires=['ete3', 'pandas', 'numpy', 'jinja2', 'colour', 'json']
)
